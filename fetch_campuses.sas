...
data campus_base;
  ...
  select (campus_code);
    ...
    when ("75") chrs_company = "SFO";
    when ("85") chrs_company = "SSU";
  ...
  select (campus_code);
    when ("05") chrs_cutover_date = "2026-05-10";
    ...
    when ("45") chrs_cutover_date = "2026-05-10";
    ...
    when ("75") chrs_cutover_date = "2026-05-10";
    when ("85") chrs_cutover_date = "2026-05-10";
